...
Public Class FormUtama
    ...
    Private Sub LanggananToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LanggananToolStripMenuItem.Click
        Dim FormLangganan As New frmLangganan()
        FormLangganan.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub DataGridView1_CellEnter(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs)
        lblPlat.Text = DataGridView1.Rows(e.RowIndex).Cells(0).Value
    End Sub

    Private Sub txtNoPlat_TextChanged(sender As Object, e As EventArgs)
