...
Public Class frmUtama
    ...
    Private Sub btnUndo_Click(sender As Object, e As EventArgs) Handles btnUndo.Click
        ...
        ' Deteksi jumlah baris yang perlu dihapus
        Dim lines As List(Of String) = TextBox1.Lines.ToList()
        Dim jumlahBarisDihapus As Integer = 0

        ' Mundur dari bawah untuk mencari baris mode gambar terakhir
                ...
                If kata.Length > 1 Then
                    Select Case kata(1)
                        Case "garis", "kotak", "kotakisi", "elips", "elipsisi"
                            Exit For ' selesai, karena sudah ketemu aksi utama terakhir
                    End Select
                End If
            End If
        Next

        ' Hapus sejumlah baris tersebut
    ...
    Private Sub BukaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BukaToolStripMenuItem.Click
        ...
        If ofd.ShowDialog = DialogResult.OK Then
            ...
            TextBox1.Text = isi
            btnGbrUlang.PerformClick() ' Gambar ulang setelah file dibuka
        End If
    End Sub
